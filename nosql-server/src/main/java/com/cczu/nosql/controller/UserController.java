...
public class UserController {
	...
	public Result<FollowStateResponse> isFollowing(@PathVariable String fromUserId, @PathVariable Long toUserId) {
	...
	public Result<FollowStateResponse> followUser(@PathVariable String fromUserId, @PathVariable Long toUserId) {
