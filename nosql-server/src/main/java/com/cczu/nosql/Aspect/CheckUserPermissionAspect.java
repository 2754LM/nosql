...
public class CheckUserPermissionAspect {
	...
	public Object validateUserPermission(ProceedingJoinPoint joinPoint, CheckUserPermission permissionAnnotation) throws Throwable {
		try {
			...
			if (permissionAnnotation == null || permissionAnnotation.value() == null || permissionAnnotation.value().trim().isEmpty()) {
	...
	private Object getFieldValue(Object obj, String fieldName) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
